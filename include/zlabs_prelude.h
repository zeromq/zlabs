/*  =========================================================================
    zlabs_prelude.h - ZLABS environment

    Copyright (c) the Contributors as noted in the AUTHORS file.
    This file is part of ZLABS, the high-level C binding for 0MQ:
    http://zlabs.zeromq.org.
...
#ifndef __ZLABS_PRELUDE_H_INCLUDED__
#define __ZLABS_PRELUDE_H_INCLUDED__
...
#   include <sys/wait.h>
#   include <sys/un.h>
#   include <sys/uio.h>             //  Let ZLABS build with libzmq/3.x
...
//  ZLABS uses uint for array indices; equivalent to unsigned int, but more
//  convenient in code. We define it in zlabs_prelude.h on systems that do
...
#if defined (__WINDOWS__)
#   define ZLABS_THREADLS __declspec(thread)
#else
#   define ZLABS_THREADLS __thread
#endif
...
#       error "ZLABS requires at least libzmq/2.1.7 stable"
#   endif
#endif
